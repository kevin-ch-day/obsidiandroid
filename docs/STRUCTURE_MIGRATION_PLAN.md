...
| P2 | **`ml_classification/`** → **`obsidiandroid.modeling` / `features` / `labeling`** façades + **wrappers** where needed | **Partial** — Training **Pass 93**, eval **Pass 94**, labeling helpers **Pass 95** (**validator**, **builder wrapper**, **postprocessor**, **field normalizer**, **format generator** under **`obsidiandroid.labeling`**); remaining **`ml_classification.builder`**, **`inference/`**, **`engine_weights/`**, **`compile_classification_results`**, etc. |
