...
SET primary_type_id = 12,
    family_status = 'active',
        is_active = 1,
        canonical_source_name = 'Kaspersky Trojan-Banker.AndroidOS.Acecard',
        canonical_source_url = 'https://threats.kaspersky.com/en/threat/Trojan-Banker.AndroidOS.Acecard/',
        review_reason = 'research_backed_authority_curation',
        review_source_name = 'Kaspersky Acecard banker overlays/SMS',
        reviewed_at_utc = UTC_TIMESTAMP()
WHERE family_id = 317
  AND family_slug = 'acecard'
