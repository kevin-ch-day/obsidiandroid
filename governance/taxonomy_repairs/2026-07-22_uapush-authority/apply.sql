...
SET primary_type_id = 2,
    family_status = 'active',
        is_active = 1,
        canonical_source_name = 'ACM Android spyware study (UaPush)',
        canonical_source_url = 'https://dl.acm.org/doi/10.1145/3382158',
        review_reason = 'research_backed_authority_curation',
        review_source_name = 'ACM UaPush spyware; Nokia/TimesLive prevalence',
        reviewed_at_utc = UTC_TIMESTAMP()
WHERE family_id = 294
  AND family_slug = 'uapush'
