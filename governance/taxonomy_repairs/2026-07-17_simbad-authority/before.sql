...
SELECT
    f.family_id, f.family_name, f.family_slug, f.family_status, f.is_active,
...
LEFT JOIN erebus_threat_intel_prod.android_malware_type AS t
  ON t.type_id = f.primary_type_id
WHERE f.family_id = 290;

SELECT
    COUNT(*) AS mapping_rows,
    COUNT(DISTINCT sample_id) AS distinct_mapped_samples,
