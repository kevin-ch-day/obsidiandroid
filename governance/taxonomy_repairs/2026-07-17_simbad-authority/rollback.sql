...
WHERE family_id = 290
  ...
  AND canonical_source_name = 'Check Point Research'
  AND canonical_source_url = 'https://research.checkpoint.com/2019/simbad-a-rogue-adware-campaign-on-google-play/'
