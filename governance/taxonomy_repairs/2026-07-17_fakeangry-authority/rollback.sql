...
WHERE family_id = 261
  ...
  AND family_status = 'active' AND is_active = 1 AND primary_type_id = 6
  AND canonical_source_name = 'Bitdefender'
  AND canonical_source_url = 'https://www.bitdefender.com/en-gb/blog/hotforsecurity/from-china-with-love-new-android-backdoor-spreading-through-hacked-apps'
