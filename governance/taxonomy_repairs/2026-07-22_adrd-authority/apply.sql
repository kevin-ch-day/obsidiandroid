...
SET family_status = 'active',
        is_active = 1,
        canonical_source_name = 'Antiy Android Trojan Adrd (HongTouTou)',
        canonical_source_url = 'https://www.antiy.net/p/android-trojan-adrd/',
        review_reason = 'research_backed_authority_curation',
        review_source_name = 'Antiy/F-Secure Adrd clicker trojan',
        reviewed_at_utc = UTC_TIMESTAMP()
WHERE family_id = 321
  AND family_slug = 'adrd'
