...
WHERE family_id = 280 AND family_slug = 'drosel'
  ...
  AND canonical_source_name = 'Canadian Institute for Cybersecurity'
  AND canonical_source_url = 'https://www.ahlashkari.com/Datasets-Android-Malware-Static-Analysis.asp'
