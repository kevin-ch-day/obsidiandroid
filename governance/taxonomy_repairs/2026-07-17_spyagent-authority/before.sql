...
SELECT
    ...
    f.is_active,
    f.primary_type_id,
    t.type_slug AS primary_type_slug,
    f.canonical_source_name,
    f.canonical_source_url,
    f.review_reason,
    f.review_source_name,
    f.reviewed_at_utc,
