...
SET primary_type_id = 13,
    family_status = 'active',
    is_active = 1,
    canonical_source_name = 'Kaspersky Securelist',
    canonical_source_url = 'https://securelist.com/ztorg-money-for-infecting-your-smartphone/78325/',
    review_reason = 'research_backed_authority_curation',
    review_source_name = 'Kaspersky Securelist; Fortinet Ztorg teardown; AMD Dropper',
    reviewed_at_utc = UTC_TIMESTAMP()
WHERE family_id = 286
  AND family_slug = 'ztorg'
