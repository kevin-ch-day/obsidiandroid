...
SET family_status = 'active',
        is_active = 1,
        canonical_source_name = 'Malpedia SmsAgent',
        canonical_source_url = 'https://malpedia.caad.fkie.fraunhofer.de/details/apk.smsagent',
        review_reason = 'research_backed_authority_curation',
        review_source_name = 'Malpedia apk.smsagent; McAfee/EST analysis refs',
        reviewed_at_utc = UTC_TIMESTAMP()
WHERE family_id = 282
  AND family_slug = 'smsagent'
