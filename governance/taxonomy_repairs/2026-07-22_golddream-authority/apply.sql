...
SET primary_type_id = 6,
    ...
    canonical_source_url = 'https://www.f-secure.com/v-descs/trojan-android-golddream.shtml',
    review_reason = 'research_backed_authority_curation',
    review_source_name = 'F-Secure; AMD 2017 Backdoor; NC State GoldDream',
    reviewed_at_utc = UTC_TIMESTAMP()
WHERE family_id = 267
  AND family_slug = 'golddream'
