...
SET primary_type_id = 1,
    family_status = 'active',
        is_active = 1,
        canonical_source_name = 'FortiGuard Android/Steek.A!tr',
        canonical_source_url = 'https://fortiguard.fortinet.com/encyclopedia/virus/3458224',
        review_reason = 'research_backed_authority_curation',
        review_source_name = 'Fortinet Android/Steek.A phishing trojan',
        reviewed_at_utc = UTC_TIMESTAMP()
WHERE family_id = 313
  AND family_slug = 'steek'
