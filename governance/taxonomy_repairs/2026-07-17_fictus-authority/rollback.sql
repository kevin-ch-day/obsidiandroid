...
WHERE family_id = 265
  ...
  AND family_status = 'active' AND is_active = 1 AND primary_type_id = 3
  AND canonical_source_name = 'FortiGuard Labs'
  AND canonical_source_url = 'https://www.fortiguard.com/encyclopedia/virus/6669669'
