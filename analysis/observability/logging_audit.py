...
def write_logging_audit_artifacts(diagnostics_dir: Path, *, run_id: str | None = None) -> tuple[Path, Path]:
    ...
    md_lines = [
        ...
        "| `PAPER_BLOCKER` | Evidence/paper contract violated when paper mode expects pass |",
        ...
        "4. Severity drift: `[DUPLICATE]` warnings are informational off paper-mode but `[PAPER]` raises—classification should map to taxonomy severities explicitly.",
    ...
    backlog_rows: list[dict[str, Any]] = [
        ...
        {
            "area": "paper_status",
            "issue": "Never print PASS for paper-safe when evidence mode is off.",
