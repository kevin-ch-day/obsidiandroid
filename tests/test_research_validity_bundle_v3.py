"""V3 policy tests for research-validity bundle export behavior."""
...
def test_canonical_profile_requires_cohort_samples_for_research_validity(
    ...
    with pytest.raises(RuntimeError, match="canonical_v3_research_validity_requires_cohort_samples"):
        rv_bundle.write_research_validity_bundle(
            run_root=tmp_path,
            diagnostics_dir=diagnostics_dir,
