"""Samples-stage V3 label contract export policy tests."""
...
def test_v3_label_contract_export_runs_when_taxonomy_target_surface_fails(
    tmp_path: Path,
    ...
    def _label_contract_ok(**_kwargs) -> list[str]:
        calls.append("v3_label_contract")
    ...
    monkeypatch.setattr(stage_samples.v3_label_contract, "export_v3_label_contract", _label_contract_ok)
    ...
    assert calls == ["v3_label_contract"]


def test_v3_label_contract_export_hard_fails_for_canonical_profile(
    tmp_path: Path,
    monkeypatch: pytest.MonkeyPatch,
) -> None:
    artifacts = _stub_samples_stage(monkeypatch, tmp_path)
    ...
    monkeypatch.setattr(stage_samples.v3_label_contract, "export_v3_label_contract", _label_contract_fail)
