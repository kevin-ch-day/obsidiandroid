...
def _provider():
    ...
    for family in range(3):
        for index in range(20):
            ...
            cohort.append({"sample_id": sample_id, "sha256": f"{family:02x}{index:02x}".ljust(64, "0"), "family_id": family, "family_canonical": f"family_{family}", "android_package_name": f"com.synthetic.f{family}.p{index}"})
