...
from analysis.diagnostics.alignment_gap_diagnostics import (  # noqa: E402
...
def main() -> int:
    ...
    detail, summary = run_alignment_gap_diagnosis(args.run_root, chunk_size=args.chunk_size)
