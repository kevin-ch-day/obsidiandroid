...
| `cleanup_output_artifacts.py` | Removes stale output artifacts and runtime logs while retaining configured recent runs. | Default is dry-run; deletion requires `--apply`. |
