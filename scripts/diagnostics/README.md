...
| [`generate_enriched_package_family_sensitivity.py`](generate_enriched_package_family_sensitivity.py) | Joint authority-lane × package/family weighting × leave-family sensitivity for RAT/banker claims. Contract: [`docs/ENRICHED_PACKAGE_FAMILY_SENSITIVITY_CONTRACT.md`](../../docs/ENRICHED_PACKAGE_FAMILY_SENSITIVITY_CONTRACT.md) |
| [`generate_robust_type_contrast.py`](generate_robust_type_contrast.py) | Tests whether joint prevalence survivors (and related candidates) discriminate types under PWF/leave weighting. Contract: [`docs/ROBUST_TYPE_CONTRAST_CONTRACT.md`](../../docs/ROBUST_TYPE_CONTRAST_CONTRACT.md) |
