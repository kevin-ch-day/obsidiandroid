...
def _default_output_dir(run_root: Path, run_id: str) -> Path | None:
    ...
    if runs_root is None:
        return (run_root.parent / "_offline_reports" / run_id / "permission_capability_categories").resolve()
    return (runs_root / "_offline_reports" / run_id / "permission_capability_categories").resolve()
