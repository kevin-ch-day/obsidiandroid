# Filename: src/obsidiandroid/vendors/execution/analysis_execution_shim.py
"""Register ``analysis.execution.*`` :class:`sys.modules` aliases.

Legacy vendor execution imports; canonical code lives under :mod:`obsidiandroid.vendors.execution`.
"""
...
_LEGACY_NAME_TO_CANON: dict[str, str] = {
    ...
    "vendor_classification_processor": (
        "obsidiandroid.vendors.execution.vendor_classification_processor"
    ),
}
